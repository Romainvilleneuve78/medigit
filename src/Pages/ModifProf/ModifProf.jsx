        ...
        <div className='modif'>
          ...
          <form onSubmit={handleClientSubmit}>
            ...
            <div className='info_2'>
              ...
              <input type="date" id="birthdate" value={birthdate} onChange={e => setBirthdate(e.target.value)} style={{width:'10%', marginRight:'27.8%'}}/>
              <label htmlFor="email">Email:</label>
              <input type="text" id="email" value={email} onChange={e => setEmail(e.target.value)} style={{width:'19.5%'}}/>
            </div>
        ...
        <div class='header_sign'>
          ...
          <div className='modif'>
            ...
            <form onSubmit={handleProfessionalSubmit}>
              ...
              <div>
                <label>Adresse d'activité:</label>
                <input type="text" value={activityAdress} onChange={(e) => setActivityAdress(e.target.value)} style={{marginRight:'18.5%', width:'19.5%'}}/>
                <label>Ville:</label>
                <input type="text" value={city} onChange={(e) => setCity(e.target.value)} />
              </div>
              ...
              <div style={{marginBottom:'3%',  display:'flex', alignItems:'start',}}>
                <label style={{width:'max-content'}}>Description:</label>
                <textarea value={description} onChange={(e) => setDescription(e.target.value)} style={{width:'20vw', fontSize:'1vw'}}/>
              </div>
