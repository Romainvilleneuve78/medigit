                  ...
                  <td>
                    <div className='container_ordo'>
                      <button className="pdp_ordo">
                        <Link to={`/Profil_pro/${prescription.Professional}`}>
                          <img src="../../images/pdp.png" alt="icone des points" />
                        </Link>
                      <span className="title_ordo">Voir le profil du médecin</span></button>
              ...
              {filteredPrescriptions.map(prescription => (
                <tr key={prescription.idPrescription}>
                  <td>
                    <div className='container_ordo'>
                      <button className="pdp_ordo">
                        <Link to={`/Profil_pro/${prescription.Client}`}>
                          <img src="../../images/pdp.png" alt="icone des points" />
                        </Link>
                      <span className="title_ordo">Voir le profil du client</span></button>
